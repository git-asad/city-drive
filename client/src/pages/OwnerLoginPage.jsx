...
const OwnerLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        const redirectTo = location.state?.from?.pathname || '/owner';
        navigate(redirectTo);
      } else {
    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-md w-full space-y-8'>
        ...
        <div className='bg-purple-50 border border-purple-200 rounded-lg p-4 mb-4'>
          <h4 className='text-sm font-medium text-purple-800 mb-2'>Demo Owner Account:</h4>
          <div className='text-xs text-purple-700 space-y-1'>
            <p><strong>Email:</strong> owner@example.com</p>
            <p><strong>Password:</strong> owner123</p>
            <p className='mt-2 text-purple-600'>Contact admin to get owner access.</p>
          </div>
        </div>
