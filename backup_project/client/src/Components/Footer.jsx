...
const Footer = () => {
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-60 text-sm text-white bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-400 border-t border-transparent shadow-inner font-[Montserrat]'>
            ...
            <div className='flex flex-wrap justify-between items-start gap-8 pb-6 border-borderColor border-b'>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-1.5'>
                        ...
                        <li><a href="#">List Yours Cars</a></li>
